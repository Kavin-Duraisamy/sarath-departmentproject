...
import { ArrowLeft, RefreshCw, AlertCircle, Undo2, FastForward } from "lucide-react"
                  ...
                  <Card key={batch.year}>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          <CardTitle className="text-xl">{batch.year} Passed Out Batch</CardTitle>
                          <p className="text-sm text-muted-foreground mt-1">
                            {batch.count} student{batch.count !== 1 ? "s" : ""} completed their program
                          </p>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="text-3xl font-bold text-primary">{batch.count}</div>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => {
