...
function BasicInfoTab({ studentData, studentId, onProfileUpdate }) {
    ...
    const handleSave = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].updateStudentProfile(studentId, payload);
    ...
    const handleImageUpload = async (e)=>{
        ...
        if (file) {
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].uploadProfilePhoto(file);
...
function AcademicsTab({ studentId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchAcademics = async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getStudent(studentId);
    ...
    const handleSave = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/students/${studentId}/academics`, {
...
function InternshipsTab({ studentId }) {
    ...
    const handleAdd = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/students/${studentId}/internships`, {
    ...
    const handleDelete = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/students/${studentId}/internships/${id}`);
            fetchInternships();
        } catch (error) {
    ...
    const handleCertificateUpload = async (e)=>{
        ...
        if (file) {
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].uploadCertificate(file);
                setFormData({
                    ...formData,
...
function ResumesTab({ studentId }) {
    ...
    const handleFileUpload = async (e)=>{
        ...
        if (file) {
            try {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].uploadResume(file);
                setFormData({
                    ...formData,
    ...
    const handleAdd = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/students/${studentId}/resumes`, {
                name: formData.name,
    ...
    const handleDelete = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/students/${studentId}/resumes/${id}`);
            fetchResumes();
        } catch (error) {
            console.error("Delete error", error);
...
function ProjectsTab({ studentId, studentYear }) {
    ...
    const saveProject = async (projectData, type, setIdFn)=>{
        try {
            ...
            if (projectData.id) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/students/${studentId}/projects/${projectData.id}`);
            }
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/students/${studentId}/projects`, {
...
function CertificatesTab({ studentId }) {
    ...
    const handleAdd = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/students/${studentId}/certificates`, {
                name: formData.name,
    ...
    const handleDelete = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/students/${studentId}/certificates/${id}`);
            fetchCertificates();
        } catch (error) {
            console.error("Delete error", error);
    ...
    const fetchStudentData = async ()=>{
        ...
        try {
            ...
            if (userData.id) {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getStudent(userData.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d4dcdc2._.js.map