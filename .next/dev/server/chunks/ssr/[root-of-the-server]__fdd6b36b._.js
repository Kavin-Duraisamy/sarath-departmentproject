...
function HODProjectsPage() {
    ...
    const fetchProjects = async ()=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].getAllProjects();
            const apiProjects = response.data.map((p)=>({
                    ...
                    domain: p.domain || (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$similarity$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectDomain"])(`${p.title} ${p.description || ""}`),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdd6b36b._.js.map