...
;
const metadata = {
    title: "Department Portal - Placement & Academic Intelligence",
    description: "Comprehensive academic management system for students, faculty, placements, and projects",
    generator: "v0.app",
    icons: {
        icon: [
            {
