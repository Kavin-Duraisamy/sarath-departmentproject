...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-toast.ts [app-ssr] (ecmascript)"); // Ensure this hook exists or use standard shadcn
// import { Toaster } from "@/components/ui/toaster" // Only if needed locally, usually in layout
...
function HODStudentsPage() {
    ...
    // Auth replaced with localStorage
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!userData || userData.role !== "hod") {
            // Optional: Redirect to correct dashboard if logged in as wrong role
            if (userData?.role) router.push(`/dashboard/${userData.role}`);
            else router.push("/");
            return;
        }
        setUser(userData);
        // Set HOD's department from session
        const department = userData.department || null;
        setHodDepartment(department);
        // Initialize formData with HOD's department
        setFormData((prev)=>({
                ...prev,
        ...
        if (storedStudents) {
            ...
            // Filter students by HOD's department if department is assigned
            const departmentFilteredStudents = department ? parsedStudents.filter((s)=>s.department === department) : parsedStudents;
            setStudents(departmentFilteredStudents);
            setFilteredStudents(departmentFilteredStudents);
        }
    }, [
        session,
        status,
    ...
    const handleBulkImport = ()=>{
        ...
        const newStudents = parsedStudents.map((row)=>({
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                        ...
                                                                        children: [
                                                                            "Import ",
                                                                            parsedStudents.length > 0 ? `${parsedStudents.length} Valid Students` : "Students"
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/app/dashboard/hod/students/page.tsx",
                                                                        lineNumber: 613,
...
//# sourceMappingURL=_b4f677c5._.js.map