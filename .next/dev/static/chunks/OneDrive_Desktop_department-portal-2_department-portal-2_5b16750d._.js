...
function FacultyManagementPage() {
    ...
    const fetchFaculty = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getUsers();
            // Filter for FACULTY only (the API might return others if role doesn't filter perfectly)
            const facultyUsers = response.data.filter((u)=>u.role === 'FACULTY').map((u)=>({
                    ...u,
                    subjects: u.subjects || [],
    ...
    const addStaffUser = async (userData)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].createUser(userData);
    ...
    const updateStaffUser = async (facultyId, formData)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].updateUser(facultyId, {
                name: formData.name,
                email: formData.email,
                username: formData.username,
                ...formData.password ? {
    ...
    const handleDeleteFaculty = async ()=>{
        ...
        try {
            if (facultyMember) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].deleteUser(facultyMember.id);
            }
    ...
    const handleSendNotification = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$department$2d$portal$2d$2$2f$department$2d$portal$2d$2$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].sendNotification({
...
//# sourceMappingURL=OneDrive_Desktop_department-portal-2_department-portal-2_5b16750d._.js.map