...
const apiClient = {
    ...
    // Batch Progression
    getProgressionHistory: ()=>api.get('/progression/history'),
    previewProgression: (department)=>api.get('/progression/preview', {
            params: {
                department
            }
        }),
    promoteBatch: (data)=>api.post('/progression/promote', data),
    rollbackProgression: (id)=>api.post(`/progression/rollback/${id}`),
    // Project Management
...
_s(ProjectsTab, "f/iq+brGu6eARSd5QPHIhlEydIQ=");
_c = ProjectsTab;
var _c;
...
//# sourceMappingURL=OneDrive_Desktop_department-portal-2_department-portal-2_65cb3d75._.js.map