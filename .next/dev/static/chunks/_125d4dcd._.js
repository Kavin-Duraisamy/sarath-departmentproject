...
"[project]/app/dashboard/admin/departments/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DepartmentsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DepartmentsPage.useEffect": ()=>{
            ...
            students.forEach({
                "DepartmentsPage.useEffect": (student)=>{
                    const dept = student.department || "Unknown";
                    departmentMap.set(dept, (departmentMap.get(dept) || 0) + 1);
                }
            }["DepartmentsPage.useEffect"]);
            // Convert to array and sort
            const deptArray = Array.from(departmentMap.entries()).map({
                "DepartmentsPage.useEffect.deptArray": ([name, count])=>({
                        name,
                        studentCount: count
                    })
            }["DepartmentsPage.useEffect.deptArray"]).sort({
                "DepartmentsPage.useEffect.deptArray": (a, b)=>a.name.localeCompare(b.name)
            }["DepartmentsPage.useEffect.deptArray"]);
...
_s(DepartmentsPage, "zDGcvEThjkVt1mZnchcczlXS6U4=", false, function() {
    return [
...
//# sourceMappingURL=_125d4dcd._.js.map